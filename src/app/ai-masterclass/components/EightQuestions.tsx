  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center bg-brand-cream px-4 py-16">
      <h3 className="text-center font-Quicksand text-2xl text-brand-orange lg:w-1/2 lg:text-4xl">
        Bring along your questions, curiosity, and excitement as Toby shows you
        how Ai can transform your business without the tech hassle.
        <br />
        <br />
        If you can't attend, simply email your questions, and we'll send you the
        recording along with answers to all queries!
      </h3>

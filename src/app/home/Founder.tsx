    ...
    <div className="h-full w-full bg-brand-green">
      <div className="mx-auto flex max-w-[1240px] flex-col items-center justify-center lg:flex-row 2xl:max-w-[1540px]">
        ...
        <div className="my-12 flex h-full w-full flex-col justify-start px-4 text-brand-cream lg:w-1/2">
          ...
          <Reveal>
            <p className="font-Quicksand text-[21px] font-light">
              Toby J is the visionary founder of Sloane, driven by a mission to
              make business easy, fun, and ridiculously efficient.<br></br>
              <br></br>
              ...
              and running a business.<br></br>
              <br></br>
              Toby recognises that the primary reason many of us start a
              business is to have the freedom to enjoy life. With Sloane, Toby
              wants to make it an indispensable tool for every entrepreneur,
              equipping them with the ability to tackle tasks confidently and
              efficiently. <br></br>
              <br></br>
              His innovative approach and unwavering commitment to user
              satisfaction have made Sloane a go-to solution for business owners
              aiming to grow and succeed while reclaiming their time and
              reducing stress.
            </p>
          </Reveal>
        </div>
        ...
        {/* right col */}
        <div className="flex h-full w-full flex-col justify-center lg:ml-8 lg:w-1/2">
          <img
            src="/images/founder.png"
            alt=""
            className="h-[550px] w-full object-cover lg:h-screen"
          />
        </div>
      </div>
    </div>
